...
<div id="wrapper">
    ...
    <div class="topbar">
        <div class="topbar-left">
            <div class="logo">
                <h1><a href="#"><img src="corporate/img/logo.png" alt="Logo"></a></h1>
            </div>
